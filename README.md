...
The structure of the code is the following:
  ...
  * Server parts : first comes the creation of the Google Sheet that enables to stock data (contributions). Please note that the sheets are initialized every day and a sheet is created for each section of the library.
